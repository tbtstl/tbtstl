...
books : List(Book)
books = [ Book "A Wild Sheep Chase" "Haruki Murakami" 2018 10
...
bookEl book = div [class "book"] [ div [class "book-year"] [text (String.fromInt book.yearRead)]
                                 , div [class "book-meta"] [div [class "book-title"] [text book.title]
...
bookContent = text "A list of books I've recently read:" :: List.map bookEl books
